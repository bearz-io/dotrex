import { Table } from "@dotrex/table";
import { bold, brightBlue, brightMagenta, dim, green, isColorEnabled, italic, red, setColorEnabled, yellow, } from "@bearz/ansi/styles";
import { inspect } from "@bearz/fmt/inspect";
...
export class HelpGenerator {
    ...
    generate() {
        const areColorsEnabled = isColorEnabled();
    ...
    generateHints(option) {
        ...
        if (typeof option.default !== "undefined") {
            ...
            if (typeof defaultValue !== "undefined") {
                hints.push(bold(`Default: `) + inspect(defaultValue, { colors: this.options.colors }));
            }
        }
        ...
        if (type instanceof Type) {
            ...
            if (possibleValues?.length) {
                hints.push(bold(`Values: `) +
                    possibleValues.map((value) => inspect(value, { colors: this.options.colors })).join(", "));
            }
        }
        if (hints.length) {
            return `(${hints.join(", ")})`;
