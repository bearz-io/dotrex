...
export type Spread<TTarget, TSource> = TTarget extends void ? TSource
    ...
    :
        ...
        & SpreadRequiredProperties<TTarget, TSource, RequiredKeys<TSource> & keyof TTarget>
        & SpreadRequiredProperties<TTarget, TSource, RequiredKeys<TTarget> & keyof TSource>
        & SpreadOptionalProperties<TTarget, TSource, OptionalKeys<TTarget> & OptionalKeys<TSource>>;
