import { type ParseFlagsContext } from "@dotrex/flags";
import type {
    MapTypes,
    MapValue,
    MergeOptions,
...
export declare class Command<
    ...
    TParentCommandTypes extends Record<string, unknown> | void = TParentCommandGlobals extends
        number ? any : void,
    TCommandOptions extends Record<string, unknown> | void = TParentCommandGlobals extends number
        ? any
        : void,
    TCommandArguments extends Array<unknown> = TParentCommandGlobals extends number ? any : [],
    TCommandGlobals extends Record<string, unknown> | void = TParentCommandGlobals extends number
        ? any
        : void,
    TCommandTypes extends Record<string, unknown> | void = TParentCommandGlobals extends number
        ? any
        : {
            number: number;
            integer: number;
    ...
    TCommandGlobalTypes extends Record<string, unknown> | void = TParentCommandGlobals extends
        number ? any : void,
    TParentCommand extends Command<any> | undefined = TParentCommandGlobals extends number ? any
        : undefined,
> {
    private types;
    private rawArgs;
    ...
    command<
        TCommand extends Command<
            ...
            >
        >,
        TGlobalOptions extends (TParentCommand extends Command<any> ? TParentCommandGlobals
            : Merge<TParentCommandGlobals, TCommandGlobals>),
        TGlobalTypes extends (TParentCommand extends Command<any> ? TParentCommandTypes
    ...
    >(
        ...
        desc?: string,
        override?: boolean,
    ): TParentCommandGlobals extends number ? Command<any>
        : Command<
     ...
     */
    allowEmpty<TAllowEmpty extends boolean | undefined = undefined>(
    ...
    protected parseOptions(
        ctx: ParseContext,
        options: Option[],
        { stopEarly, stopOnUnknown, dotted }?: ParseOptionsOptions,
    ): void;
    /** Parse argument type. */
     ...
     * @param hidden Include hidden commands.
     */
    getBaseCommand<TCommand extends Command<any>>(
        name: string,
        hidden?: boolean,
    ): TCommand | undefined;
    /**
     ...
     * @param hidden Include hidden commands.
     */
    getGlobalCommand<TCommand extends Command<any>>(
        name: string,
        hidden?: boolean,
    ): TCommand | undefined;
    /**
