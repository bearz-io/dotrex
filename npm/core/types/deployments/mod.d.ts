...
export type DeploymentEventHandler = (
  ctx: DeploymentContext,
) => Promise<DeploymentEventResult>;
...
export declare abstract class Deployment
  implements Record<string | symbol, unknown> {
  ...
  abstract run(
    ctx: DeploymentContext,
  ): Promise<Outputs | void> | void | Outputs;
...
export interface DelegateDeploymentParams
  extends Partial<Omit<DelegateDeployment, "id">> {
  id: string;
  run: DeployDelegate;
