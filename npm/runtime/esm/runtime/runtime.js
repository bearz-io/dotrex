...
import { LogLevels } from "@dotrex/core/host";
import { writer } from "./host/writer.js";
import { Inputs, Outputs, StringMap } from "@dotrex/core/collections";
import { DefaultLoggingMessageBus } from "./bus/mod.js";
import { tasksConsoleSink } from "./tasks/console_sink.js";
import { jobsConsoleSink } from "./jobs/console_sink.js";
import { deployConsoleSink } from "./deployments/console_sink.js";
import { SequentialTasksPipeline, TaskPipeline, TasksPipelineContext } from "./tasks/pipelines.js";
import { PipelineStatuses } from "@dotrex/core/enums";
import * as env from "@bearz/env";
import { DiscoveryPipeline, DiscoveryPipelineContext } from "./discovery/pipelines.js";
import { RexfileDiscovery } from "./discovery/middlewares.js";
import { ApplyTaskContext, SequentialTaskExecution, TaskExecution } from "./tasks/middlewares.js";
import { JobsPipelineContext, SequentialJobsPipeline } from "./jobs/pipelines.js";
import { ApplyJobContext, JobsExcution, RunJob } from "./jobs/middlewares.js";
import { JobPipeline } from "./jobs/pipelines.js";
import { DeploymentPipeline, DeploymentPipelineContext } from "./deployments/pipelines.js";
import { parse } from "@bearz/dotenv";
import { load } from "@bearz/dotenv/load";
import { readTextFile } from "@bearz/fs";
import { ApplyDeploymentContext, RunDeployment } from "./deployments/middleware.js";
import { Context } from "@dotrex/core/context";
import { ServicesContainer } from "./di/mod.js";
export class Runner {
    constructor() {
    }
    async run(options) {
                ...
                case "run":
                    {
                        ...
                        const results = await tasksPipeline.run(tasksCtx);
                        if (results.error) {
