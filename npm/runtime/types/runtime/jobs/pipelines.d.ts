...
export declare class JobPipeline
  extends Pipeline<JobResult, JobPipelineContext> {
  constructor();
  use(
    middleware:
...
export declare class SequentialJobsPipeline
  extends Pipeline<JobsSummary, JobsPipelineContext> {
  constructor();
  use(
    middleware:
