...
import type { ArgumentValue, CompleteHandlerResult, ValuesHandlerResult } from "./types.ts";
...
export namespace Type {
    export type infer<TType, TDefault = TType> = TType extends TypeOrTypeHandler<infer Value>
        ? Value
        : TDefault;
}
